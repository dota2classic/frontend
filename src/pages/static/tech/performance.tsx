...
export default function PerformanceTechTab() {
  ...
  return (
    <StaticPageShell
      eyebrow="Tech"
      title={t("performance_tab.performanceSettings")}
      description={t("performance_tab.performanceImprovementDescription")}
      embedTitle={t("performance_tab.performanceImprovementTitle")}
      embedDescription={t("performance_tab.performanceImprovementDescription")}
      tabs={<TechStaticTabs />}
    >
      <SectionBlock title={t("performance_tab.removeLagTitle")}>
      ...
      <SectionBlock title={t("performance_tab.netgraphTitle")}>
        <div className={c.block}>
          <ul>
            <li>
              <CopyBlock
      ...
      <SectionBlock title={t("performance_tab.performanceCommandsTitle")}>
        <div className={c.block}>
          <ul>
            <li>
              <CopyBlock
      ...
      <SectionBlock title={t("performance_tab.improvingResponsivenessTitle")}>
        <div className={c.block}>
          <p>{t("performance_tab.ifPingBelow")}</p>
          <CopyBlock
            text={t("performance_tab.command1")}
            command="сl_interp 0"
          />
          <CopyBlock
