      ...
      <FAQ
        items={[
          ...
          },
          {
            ...
            content: (
              <>
                Он был выкачан напрямую из официальных Steam-депотов, то есть
                полностью аутентичен. Серверы работают на официальном
          ...
          {
            title: "Я не могу загрузиться в игру",
            content: (
              <>
                <ul>
          ...
          {
            title:
              "Графические или звуковые артефакты / вылетает из игровой карты",
            content: <>Snd_restart или переустановить аудиодрайвер</>,
          },
          {
