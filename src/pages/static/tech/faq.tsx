...
export default function FaqTechTab() {
  ...
  return (
    <StaticPageShell
      ...
      embedTitle={t("faq.title")}
      embedDescription={t("faq.description")}
      tabs={<TechStaticTabs />}
    >
      <SectionBlock title={t("faq.header")}>
        <FAQ
          items={[
            {
              ...
              content: (
                <>
                  ...
                  <ol>
                    ...
                    <li>
                      {t("faq.items.graphicsAudio.content.driverInstall")}
                    </li>
                    <li>{t("faq.items.graphicsAudio.content.audioRestart")}</li>
                    <li>
                      {t("faq.items.graphicsAudio.content.disableExtras")}
                    </li>
                    <li>
