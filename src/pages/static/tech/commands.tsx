  ...
  return (
    <div className={cx(NotoSans.className, c.container)}>
      ...
      <div className={c.block}>
        <ol>
          <li>
            Находим файл <span className="gold">Dota 6.84/dota/bin</span>
          </li>
          <li>Открываем его с помощью notepad или блокнота</li>
          <li>
          ...
          <li>Клиент нужно перезапускать после каждого изменения</li>
          <li>
            Вот готовый файл{" "}
