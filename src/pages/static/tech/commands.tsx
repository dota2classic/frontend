...
export default function CommandsTechTab() {
  ...
  return (
    <StaticPageShell
      eyebrow="Tech"
      title={t("commands_tech_tab.clientSetup")}
      description={t("commands_tech_tab.oldClientDescription")}
      embedTitle={t("commands_tech_tab.clientSetupTitle")}
      embedDescription={t("commands_tech_tab.oldClientDescription")}
      tabs={<TechStaticTabs />}
    >
      <SectionBlock title={t("commands_tech_tab.usefulConsoleCommands")}>
      ...
      <SectionBlock title={t("commands_tech_tab.cameraDistance")}>
        <div className={c.block}>
          <ol>
            <li>
            ...
            <li>
              ...
              <a
                href="https://disk.yandex.ru/d/re1lVyKCeoXx-Q"
                className="link"
              >
                client.dll
              </a>
      ...
      <SectionBlock title={t("commands_tech_tab.quickCastsAndSelfCasting")}>
        <div className={c.block}>
          <ol>
            <li>
      ...
      <SectionBlock title={t("commands_tech_tab.highlightUnits")}>
        <div className={c.block}>
          <p>
