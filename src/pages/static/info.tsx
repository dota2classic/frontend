    ...
    <>
      ...
      <div className={cx(c.postContainer, NotoSans.className)}>
        ...
        <p>
          ...
          скачивания клиента, техническую поддержку и базу знаний по патчу.
        </p>
        <p>
          Мы предоставляем возможность бесплатно поиграть онлайн в старую доту
        ...
        <p>
          ...
          убедить, что эта версия игры - эталон. Тем не менее, поиграть в
          оригинальную игру может быть интересно всем. Основные отличия:
        </p>
        <ul>
          <li>
