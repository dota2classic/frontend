...
export default function RulesPage() {
  return (
    <div className={cx(c.postContainer, NotoSans.className)}>
      ...
      <p className="editor-paragraph">
        <span className={c.part}>1.2.3</span>. Любые формы травли других игроков
        запрещены.
      </p>
      <p className="editor-paragraph">
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>1.2.4</span>. Совершение действий, направленных
        на предоставление преимущества противнику, включая:
      </p>
      <ul>
      ...
      <p className="editor-paragraph">
        <span className={c.part}>1.2.6</span>. Предоставление игровой информации
        противнику, наносящее ущерб своим союзникам.
      </p>
      <p className="editor-paragraph">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>1.2.9</span>. Использование способностей героя,
        эффектов предметов или игровых механик против собственных союзников,
        включая:
      </p>
      <ul>
        <li>
      ...
      <p className="editor-paragraph">
        <span className={c.part}>1.2.14.</span> Запрещено внедрение в командное
        взаимодействие с целью «троллинга».
      </p>
      <p className="editor-paragraph">
        ...
        <strong className="editor-text-bold">(«лоускилл»),</strong> причиняющий
        экстремальный ущерб игровому процессу и другим участникам, наказывается{" "}
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        ...
        <span className={c.part}></span> В частности, наличие хотя бы одного из
        нижеследующих критериев (метрик) за 50 игр подтверждает крайне низкий
        уровень игры:
        <br />
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          отсутствие прогресса или крайне низкий уровень улучшений в мастерстве
          игры за значительный период;
        </li>
        <li>
      ...
      <p className="editor-paragraph">
        ...
        является исчерпывающими - мы оставляем за собой право определять, какое
        поведение считается нарушением наших правил в каждой конкретной
        ситуации.
      </p>
      <p className="editor-paragraph">
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        ...
        дискриминация, клевета и другие нарушения культуры общения с остальными
        игроками <strong className="editor-text-bold">(«токсичность»)</strong>.
      </p>
      <p className="editor-paragraph">
      ...
      <p className="editor-paragraph">
        ...
        <br />
        <span className={c.part}>2.1.2</span>. Оффтопик в тематических разделах
        недопустим.
      </p>
      <p className="editor-paragraph">
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        ...
        участников (включая намёки и пассивно-агрессивное выражение) запрещены.
        <br />
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>2.3.1</span>. Использование форума для рекламы
        (прямой или скрытой) без согласия администрации запрещено.
        <br />
      ...
      <h3 className="editor-heading-h2">
        <strong className="editor-text-bold">Раздел 3. Ответственность</strong>
      </h3>
      <p className="editor-paragraph">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>3.2.</span> Любое нарушение рассматривается на
        усмотрение администрации. В случае спорных моментов участник имеет право
        обратиться с апелляцией.
      </p>
      <h3 className="editor-heading-h2">
        <strong className="editor-text-bold">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>4.1.1</span>. Каждый участник сообщества имеет
        право подать жалобу на другого игрока.
      </p>
      <p className="editor-paragraph">
      ...
      <p className="editor-paragraph">
        <span className={c.part}>5.2.1</span>. Каждый пользователь несёт личную
        ответственность за свои действия в игре и на платформах, принадлежащих
        сообществу.
        <br />
        <strong className="editor-text-bold">
