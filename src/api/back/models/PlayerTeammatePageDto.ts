...
export function PlayerTeammatePageDtoFromJSON(json: any): PlayerTeammatePageDto {
    return PlayerTeammatePageDtoFromJSONTyped(json, false);
}

export function PlayerTeammatePageDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerTeammatePageDto {
...
export function PlayerTeammatePageDtoToJSON(value?: PlayerTeammatePageDto | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
