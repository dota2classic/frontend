...
const gameModeDescriptions = {
  ...
  // MatchmakingMode.HIGHROOM
  [MatchmakingMode.HIGHROOM]:
    "Режим для более опытных игроков, которые хотят сыграть спокойную и качественную игру без ливеров. Рейтинг меняется за победы и поражения, а доступ открывается после 50 сыгранных матчей.",
  // MatchmakingMode.BOTS
  [MatchmakingMode.BOTS]:
